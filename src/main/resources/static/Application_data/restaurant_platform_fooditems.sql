...
CREATE TABLE `fooditems` (
  ...
  `menu_category_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKgvgu3dx75wcgjywk5g0l7dmum` (`menu_category_id`),
  CONSTRAINT `FKgvgu3dx75wcgjywk5g0l7dmum` FOREIGN KEY (`menu_category_id`) REFERENCES `menucategories` (`id`)
